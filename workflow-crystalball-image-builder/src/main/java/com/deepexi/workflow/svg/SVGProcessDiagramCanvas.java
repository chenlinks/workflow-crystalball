...
import com.deepexi.workflow.ImageTypes;
...
public class SVGProcessDiagramCanvas extends ProcessDiagramCanvas {
    ...
    public SVGProcessDiagramCanvas(int width, int height, int minX, int minY, ImageTypes imageTypes ) {
        super(width, height, minX, minY,imageTypes.name());
