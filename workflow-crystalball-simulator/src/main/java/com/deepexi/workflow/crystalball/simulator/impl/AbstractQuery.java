...
public abstract class AbstractQuery<T extends Query<?,?>, U> extends ListQueryParameterObject implements Command<Object>, Query<T,U>, Serializable {
  ...
  public U singleResult() {
    ...
    return executeSingleResult(SimulationContext.getCommandContext());
  }
  ...
  public List<U> list() {
    ...
    return executeList(SimulationContext.getCommandContext(), null);
  }
  ...
  public List<U> listPage(int firstResult, int maxResults) {
    ...
    return executeList(SimulationContext.getCommandContext(), new Page(firstResult, maxResults));
  }
  ...
  public long count() {
    ...
    return executeCount(SimulationContext.getCommandContext());
  }
