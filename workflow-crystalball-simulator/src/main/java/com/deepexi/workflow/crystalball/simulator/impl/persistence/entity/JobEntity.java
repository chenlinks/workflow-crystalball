 ...
 */
public class JobEntity implements Serializable, Job, PersistentObject, HasRevision {
  ...
  protected String simulationInstanceId = null;
  ...
  public void execute(CommandContext commandContext) {
    SimulationInstanceEntity simulationInstance = null;
    if (simulationInstanceId != null) {
      simulationInstance = commandContext.getSimulationInstanceManager().findSimulationInstanceById(simulationInstanceId);
    }

    Map<String, JobHandler> jobHandlers = SimulationContext.getSimulationEngineConfiguration().getJobHandlers();
    JobHandler jobHandler = jobHandlers.get(jobHandlerType);

    jobHandler.execute(this, jobHandlerConfiguration, simulationInstance, commandContext);
  }
  
  public void insert() {
    DbSimulatorSqlSession dbSqlSession = SimulationContext
      .getCommandContext()
      .getDbSqlSession();
...
//    if(simulationInstanceId != null) {
//      SimulationInstanceEntity execution = SimulationContext.getCommandContext()
//    		  .getSimulationInstanceManager().findSimulationInstanceById(simulationInstanceId);
...
//  }
  ...
  public void setSimulationInstanceId(String simulationInstanceId) {
  ...
  private ByteArrayEntity getExceptionByteArray() {
    if ((exceptionByteArray == null) && (exceptionByteArrayId != null)) {
      exceptionByteArray = SimulationContext
        .getCommandContext()
        .getDbSqlSession()
