...
public abstract class AbstractNativeQuery<T extends NativeQuery< ? , ? >, U> implements Command<Object>, NativeQuery<T, U>,
  ...
  public List<U> list() {
    ...
    return executeList(SimulationContext.getCommandContext(), getParameterMap(), 0, Integer.MAX_VALUE);
  }
  ...
  public long count() {
    ...
    return executeCount(SimulationContext.getCommandContext(), getParameterMap());
  }
