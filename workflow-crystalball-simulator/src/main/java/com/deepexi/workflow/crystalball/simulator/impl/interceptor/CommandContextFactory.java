...
public class CommandContextFactory {
  ...
  public CommandContext createCommandContext(Command<?> cmd) {
    return new CommandContext(cmd, simulationEngineConfiguration);
  }
  
  // getters and setters //////////////////////////////////////////////////////
  
  public SimulationEngineConfigurationImpl getProcessEngineConfiguration() {
    return simulationEngineConfiguration;
  }

  public void setSimulationEngineConfiguration(SimulationEngineConfigurationImpl processEngineConfiguration) {
